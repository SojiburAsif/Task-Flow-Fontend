...
- **🎨 Premium UI/UX:** Shared UI primitives crafted with Tailwind CSS v4, Radix UI, Framer Motion, and Sonner toast notifications for a signature **Sharp-Brutalist** aesthetic.
